...
* [accident.ipynb (accident report system)](Activities/05-Ins_Filters_Web3_IPFS/Solved/accident.ipynb)
...
We'll need to create a notebook called `accident.ipynb`.

* `accident.ipynb` is going to allow us to interact with the contract from within the notebook.
...
Next, we'll need to create the function that will send the event to the blockchain:
...
The slides for this section can be viewed on Google Drive here: [Project 3 Slides](https://docs.google.com/presentation/d/1sCsFHMt6Qw8iuX1o6Z8SQo7g5RhSILMGIb6cHNQS1bc/edit?usp=sharing). Using the slides, present the project guidelines to the class. Be sure to highlight the following:
 
   * Explain that students can choose **any topic** from any section of the course as their capstone project.

   * Point out that this allows them to align their capstone project with their specific career goals, and that the final project **does not have to focus on Blockchain**.
